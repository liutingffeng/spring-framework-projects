package lifecycle.e_source;

import lifecycle.e_source.bean.Cat;
import lifecycle.e_source.bean.Person;
import lifecycle.e_source.config.LifecycleDestructionPostProcessor;
import lifecycle.e_source.config.LifecycleNameReadPostProcessor;
import lifecycle.e_source.config.LifecycleSourceConfiguration;
